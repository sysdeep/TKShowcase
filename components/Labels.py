...
class Labels(ttk.Frame):
	def __init__(self, master, *args, **kwargs):
		...
		ttk.Label(self, text="bottom", image=self.img, compound="bottom").grid(row=row, column=1)
		ttk.Label(self, text="left", image=self.img, compound="left").grid(row=row, column=2)
		ttk.Label(self, text="right", image=self.img, compound="right").grid(row=row, column=3)
		ttk.Label(self, text="top", image=self.img, compound="top").grid(row=row, column=4)
